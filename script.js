...
const locations = [
    {
        ...
        text: 'You are in the town squere "store"',
    },
    {
		name: "store",
...
function buyHealth(){
    ...
    }else text.innerHTML = "Out of gold";
...
function buyWeapon(){
    if(currentWeapon< weapons.length - 1){
        if(gold>=30){
            ...
            text.innerHTML = `You bought a ${newWeapon}`; 
            inventory.push(newWeapon);
            text.innerHTML += `${'<br>'}Now you have ${inventory}`
        }else text.innerHTML = "Not enough gold";
    }else{
        text.innerHTML = "You already have the strongest weapon"
        button2.innerHTML = "Sell weapon for";
...
function sellWeapon(){
    if(inventory.length>1){
        ...
        text.innerHTML += `${'<br>'}Now you have ${inventory}`
    }else text.innerHTML = "You tried to sell your only weapon"
}
function fightSlime(){
    fighting = 0;
    goFight();
